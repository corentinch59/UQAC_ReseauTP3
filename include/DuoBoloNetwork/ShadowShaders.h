...
"            ivec2 pixelCoord = ivec2(sampleCoords/texelSize + vec2(x, y));"
"            if (pixelCoord.x < 0 || pixelCoord.y < 0 || pixelCoord.x > shadowMapResolution || pixelCoord.y > shadowMapResolution) isSampleOutside = true;\n"
"        }\n"
"    }\n"
"    finalColor = mix(finalColor, vec4(0, 0, 0, 1), isSampleOutside ? 0 : float(shadowCounter)/float(numSamples));\n"
"\n"
